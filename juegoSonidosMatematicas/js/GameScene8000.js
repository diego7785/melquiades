class GameScene8000 extends Phaser.Scene{
    constructor(){
        super("gameScene8000");
    ...
    preload(){
        ...
        this.load.image("playText", "./assets/img/playText.png");
        this.load.image("playIcon", "./assets/img/playIcon.png");

        this.load.image("8000", "./assets/img/8000.png");

        this.load.image("lineCurve", "./assets/img/lineCurve.png");
        this.load.image("modal", "./assets/img/modal.png");
        this.load.image("hear", "./assets/img/hearText.png");
        this.load.image("yes", "./assets/img/yes.png");
        this.load.image("no", "./assets/img/no.png");

        this.load.image("yesNext8000", "./assets/img/yesNext8000.png");
        this.load.image("noNext8000", "./assets/img/noNext8000.png");
    ...
    create(){
        ...
        var hz = this.physics.add.sprite(this.width/2, this.height/1.7,"8000").setScale(fEscalaW, fEscalaH);
        ...
        var yesNext8000 = this.physics.add.sprite(this.width/2, this.height/1.4,"yesNext8000").setScale(0.3);
        yesNext8000.visible=false;
        yesNext8000.depth=11;
        var noNext8000 = this.physics.add.sprite(this.width/2, this.height/1.4,"noNext8000").setScale(0.3);
        noNext8000.visible=false;
        noNext8000.depth=11;
        ...
        // Audios
        var Hz8000A =this.sound.add("8000Hz");
        ...
        next.on('pointerdown', () => {
            next.setScale(0.8);
            this.scene.start("gameScene12000");
        })
    ...
    update(){
        if(this.end){
            this.graphics.destroy();//.setPosition(400000000000,this.height/3-(214*this.escalaG));
