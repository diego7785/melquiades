class GameScene20000 extends Phaser.Scene{
    constructor(){
        super("gameScene20000");
    ...
    preload(){
        ...
        this.load.image("20000", "./assets/img/20000.png");
        this.load.image("yesNext20000", "./assets/img/yesNext20000.png");
        this.load.image("noNext20000", "./assets/img/noNext20000.png");
    }
    ...
    create(){
        ...
        var hz = this.physics.add.sprite(this.width/2, this.height/1.7,"20000").setScale(fEscalaW, fEscalaH);
        ...
        var yesNext20000 = this.physics.add.sprite(this.width/2, this.height/1.4,"yesNext20000").setScale(0.3);
        yesNext20000.visible=false;
        yesNext20000.depth=11;
        var noNext20000 = this.physics.add.sprite(this.width/2, this.height/1.4,"noNext20000").setScale(0.3);
        noNext20000.visible=false;
        noNext20000.depth=11;
        ...
        var Hz20000A = this.sound.add("20000Hz");
