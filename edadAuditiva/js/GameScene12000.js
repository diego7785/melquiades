class GameScene12000 extends Phaser.Scene{
    constructor(){
        super("gameScene12000");
    ...
    preload(){
        ...
        this.load.image("12000", "./assets/img/12000.png");
        this.load.image("yesNext12000", "./assets/img/yesNext12000.png");
        this.load.image("noNext12000", "./assets/img/noNext12000.png");
    ...
    create(){
        ...
        var hz = this.physics.add.sprite(this.width/2, this.height/1.7,"12000").setScale(fEscalaW, fEscalaH);
        ...
        var yesNext12000 = this.physics.add.sprite(this.width/2, this.height/1.4,"yesNext12000").setScale(0.3);
        yesNext12000.visible=false;
        yesNext12000.depth=11;
        var noNext12000 = this.physics.add.sprite(this.width/2, this.height/1.4,"noNext12000").setScale(0.3);
        noNext12000.visible=false;
        noNext12000.depth=11;
        ...
        var Hz12000A = this.sound.add("12000Hz");
        ...
        next.on('pointerdown', () => {
            next.setScale(0.8);
            this.scene.start("gameScene15000");
        })
