class GameScene16000 extends Phaser.Scene{
    constructor(){
        super("gameScene16000");
    ...
    preload(){
        ...
        this.load.image("16000", "./assets/img/16000.png");
        this.load.image("yesNext16000", "./assets/img/yesNext16000.png");
        this.load.image("noNext16000", "./assets/img/noNext16000.png");
    }
    ...
    create(){
        ...
        var hz = this.physics.add.sprite(this.width/2, this.height/1.7,"16000").setScale(fEscalaW, fEscalaH);
        ...
        var yesNext16000 = this.physics.add.sprite(this.width/2, this.height/1.4,"yesNext16000").setScale(0.3);
        yesNext16000.visible=false;
        yesNext16000.depth=11;
        var noNext16000 = this.physics.add.sprite(this.width/2, this.height/1.4,"noNext16000").setScale(0.3);
        noNext16000.visible=false;
        noNext16000.depth=11;
        ...
        var Hz16000A = this.sound.add("16000Hz");
        ...
        next.on('pointerdown', () => {
            next.setScale(0.8);
            this.scene.start("gameScene18000");
        })
