class GameScene18000 extends Phaser.Scene{
    constructor(){
        super("gameScene18000");
    ...
    preload(){
        ...
        this.load.image("18000", "./assets/img/18000.png");
        this.load.image("yesNext18000", "./assets/img/yesNext18000.png");
        this.load.image("noNext18000", "./assets/img/noNext18000.png");
    }
    ...
    create(){
        ...
        var hz = this.physics.add.sprite(this.width/2, this.height/1.7,"18000").setScale(fEscalaW, fEscalaH);
        ...
        var yesNext18000 = this.physics.add.sprite(this.width/2, this.height/1.4,"yesNext18000").setScale(0.3);
        yesNext18000.visible=false;
        yesNext18000.depth=11;
        var noNext18000 = this.physics.add.sprite(this.width/2, this.height/1.4,"noNext18000").setScale(0.3);
        noNext18000.visible=false;
        noNext18000.depth=11;
        ...
        var Hz18000A = this.sound.add("18000Hz");
        ...
        next.on('pointerdown', () => {
            next.setScale(0.8);
            this.scene.start("gameScene20000");
        })
